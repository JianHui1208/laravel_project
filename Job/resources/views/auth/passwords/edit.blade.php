            ...
            <div class="card-body">
                <form method="POST" action="{{ route("profile.password.updateProfile") }}">
                    ...
                    <div class="form-group">
                        <label class="required" for="FristName">{{ trans('cruds.user.fields.name') }}</label>
                        <input class="form-control {{ $errors->has('FristName') ? 'is-invalid' : '' }}" type="text" name="FristName" id="FristName" value="{{ old('FristName', auth()->user()->FristName) }}" required readonly>
